...
| Selected as completable in a single session | 13 |
| HIGH | 2 |
| MEDIUM | 6 |
| LOW | 5 |
| Requiring an explicit user design decision | 9 |
| Batches produced | 5 |
| Cross-batch file conflicts | **0** (verified programmatically) |
| Deferred by file contention | 2 |
...
|---|---|---|
| `THE SIGNAL REGISTRY'S sample_floor=20 CLEARS AT ~27% STATISTICAL POWER` | MEDIUM-HIGH | `weather_markets.py` (76) + `main.py` (79) |
