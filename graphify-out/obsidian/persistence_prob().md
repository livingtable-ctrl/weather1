...
## Connections
- [[26 Persistence baseline — models tomorrow's temperature as N(current_value,…]] - `rationale_for` [EXTRACTED]
- [[dot-test_above_condition()_1]] - `calls` [EXTRACTED]
- [[dot-test_above_threshold_high_current()]] - `calls` [EXTRACTED]
- [[dot-test_above_threshold_low_current()]] - `calls` [EXTRACTED]
- [[dot-test_below_condition()_1]] - `calls` [EXTRACTED]
- [[dot-test_below_threshold_low_current()]] - `calls` [EXTRACTED]
- [[dot-test_between_condition()_1]] - `calls` [EXTRACTED]
- [[dot-test_between_returns_reasonable_value()]] - `calls` [EXTRACTED]
