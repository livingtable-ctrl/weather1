...
## Connections
- [[Attach forecast data to a market dict. Parses city, date, and (for hourly…]] - `rationale_for` [EXTRACTED]
...
- [[test_data_freshness.py]] - `calls` [EXTRACTED]
- [[test_enrich_with_forecast_stamps_data_fetched_at()]] - `calls` [EXTRACTED]
