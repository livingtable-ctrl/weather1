...
- [[dot-test_function_not_importable()]] - code - tests/test_phase3_batch_d.py
- [[dot-test_simulate_portfolio_signature_has_include_distribution()]] - code - tests/test_phase3_batch_d.py
- [[P3-18 stratified_train_test_split must not exist in backtest module.]] - rationale - tests/test_phase3_batch_d.py
- [[P3-23 pnl_distribution must only appear in output when…]] - rationale - tests/test_phase3_batch_d.py
- [[Phase 3 Batch D Monte CarloBacktest Tests]] - code - tests/test_phase3_batch_d.py
...
- [[TestStratifiedSplitRemoved]] - code - tests/test_phase3_batch_d.py
