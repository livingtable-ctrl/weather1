...
## Connections
- [[dot-test_blocks_even_when_city_and_date_are_present()_2]] - `method` [EXTRACTED]
- [[dot-test_daily_ticker_unaffected()_3]] - `method` [EXTRACTED]
- [[dot-test_does_not_block_when_gate_active()_2]] - `method` [EXTRACTED]
- [[dot-test_still_blocks_when_gate_inactive()_2]] - `method` [EXTRACTED]
