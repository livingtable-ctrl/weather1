...
- [[Minimal stub of the Kalshi client's get_market(ticker) surface._1]] - rationale - tests/test_paper.py
- [[NO holder can only realize (1 - yes_ask) — mark_pnl = ((1-ask) - entry)  qty.]] - rationale - tests/test_paper.py
- [[NO holder can only realize (1 - yes_ask) — mark_pnl = ((1-ask) - entry)  qty._1]] - rationale - tests/test_paper.py
...
- [[YES holder can only realize the bid — mark_pnl = (bid - entry)  qty._1]] - rationale - tests/test_paper.py
...
- [[yes_frac == 0.4 exactly must NOT count as NO-heavy (strict )._1]] - rationale - tests/test_paper.py
- [[yes_frac == 0.6 exactly must NOT count as YES-heavy (strict ).]] - rationale - tests/test_paper.py
- [[yes_frac == 0.6 exactly must NOT count as YES-heavy (strict )._1]] - rationale - tests/test_paper.py
...
## Top bridge nodes
- [[_FakeMarketClient]] - degree 10, connects to 2 communities
