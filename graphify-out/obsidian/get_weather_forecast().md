...
## Connections
- [[dot-test_all_models_fail_returns_none()]] - `calls` [EXTRACTED]
- [[dot-test_dead_model_all_null_response_treated_as_failure()]] - `calls` [EXTRACTED]
- [[dot-test_partial_model_failure_still_returns()]] - `calls` [EXTRACTED]
- [[dot-test_returns_forecast_when_all_models_respond()]] - `calls` [EXTRACTED]
