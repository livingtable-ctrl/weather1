...
- [[NOAA ACIS StnData (month-to-date actual + historical daily precipitation) and…]] - `rationale_for` [EXTRACTED]
...
- [[apply_seasonal_tilt()]] - `contains` [EXTRACTED]
- [[bootstrap_ci_month_total()]] - `contains` [EXTRACTED]
- [[circuit_breaker.py]] - `imports_from` [EXTRACTED]
- [[fetch_historical_daily()]] - `contains` [EXTRACTED]
- [[fetch_month_to_date_actual()]] - `contains` [EXTRACTED]
