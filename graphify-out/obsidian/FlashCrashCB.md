...
- [[dot-test_second_instance_does_not_false_positive_on_small_move()]] - `calls` [EXTRACTED]
- [[dot-test_second_instance_on_same_path_detects_crash_from_first()]] - `calls` [EXTRACTED]
- [[Per-market flash crash detection. Trips when price moves  threshold_pct within…]] - `rationale_for` [EXTRACTED]
- [[TestFlashCrashCB]] - `uses` [INFERRED]
- [[TestFlashCrashCBHistoryPersistence]] - `uses` [INFERRED]
- [[TestFlashCrashCBHistorySaveThrottle]] - `uses` [INFERRED]
