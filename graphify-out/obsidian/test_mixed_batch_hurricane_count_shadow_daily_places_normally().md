...
# test_mixed_batch_hurricane_count_shadow_daily_places_normally()

## Connections
- [[The core routing guarantee in one batch, a hurricane-count opp (gate inactive)…]] - `rationale_for` [EXTRACTED]
