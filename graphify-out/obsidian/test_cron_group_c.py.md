...
## Connections
- [[Regression tests for cron.py's Group C Fable findings manual-override fail-…]] - `rationale_for` [EXTRACTED]
- [[TestAnomalyBlackSwanCallsFailClosed]] - `contains` [EXTRACTED]
- [[TestEdgeFlagWired]] - `contains` [EXTRACTED]
