...
- [[test_config_divergence_guard.py]] - `shares_data_with` [INFERRED]
- [[test_paths_module_exports_critical_paths()]] - `contains` [EXTRACTED]
- [[test_validate_config_does_not_exit_in_demo_when_keys_missing()]] - `contains` [EXTRACTED]
