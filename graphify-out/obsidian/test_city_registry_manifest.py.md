...
- [[test_known_gaps_are_still_actually_gaps()]] - `contains` [EXTRACTED]
- [[test_metar_station_fully_covered()]] - `contains` [EXTRACTED]
- [[test_no_new_unexplained_registry_gaps()]] - `contains` [EXTRACTED]
- [[test_report_covers_all_city_coords_cities()]] - `contains` [EXTRACTED]
- [[test_series_ticker_fully_covered()]] - `contains` [EXTRACTED]
- [[test_st_petersburg_series_ticker_comes_from_rain_not_high()]] - `contains` [EXTRACTED]
