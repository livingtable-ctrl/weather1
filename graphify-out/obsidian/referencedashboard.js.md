...
## Connections
- [[loadBalanceChart()_1]] - `contains` [EXTRACTED]
- [[loadCircuitStatus()_1]] - `contains` [EXTRACTED]
- [[loadGraduation()_1]] - `contains` [EXTRACTED]
- [[loadLivePnl()_1]] - `contains` [EXTRACTED]
- [[loadOpenPositions()_1]] - `contains` [EXTRACTED]
