...
## Connections
- [[126 Return seconds until the next NWP model cycle data becomes available. NWP…]] - `rationale_for` [EXTRACTED]
- [[dot-test_05_utc_ttl_is_approx_3600()]] - `calls` [EXTRACTED]
- [[dot-test_after_all_cycles_wraps_to_next_day()]] - `calls` [EXTRACTED]
- [[dot-test_minimum_ttl_is_1800()]] - `calls` [EXTRACTED]
