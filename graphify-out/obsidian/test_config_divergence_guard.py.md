...
## Connections
- [[Automated guard against the config-divergencedead-field bug class. This…]] - `rationale_for` [EXTRACTED]
- [[BotConfig]] - `imports` [EXTRACTED]
- [[BotConfig class]] - `references` [EXTRACTED]
- [[_botconfig_field_names()]] - `contains` [EXTRACTED]
- [[_has_real_call_site()]] - `contains` [EXTRACTED]
