...
# test_hurricane_count_ticker_places_normally_when_gate_active()

## Connections
- [[Once _hurricane_count_gates_active() is True, a hurricane-count opp places…]] - `rationale_for` [EXTRACTED]
