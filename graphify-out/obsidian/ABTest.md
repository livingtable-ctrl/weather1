...
- [[dot-test_auto_disable_low_performer()]] - `calls` [EXTRACTED]
...
- [[dot-test_pick_variant_all_exhausted_falls_back_to_control()]] - `calls` [EXTRACTED]
- [[dot-test_pick_variant_returns_valid_variant()]] - `calls` [EXTRACTED]
- [[dot-test_pick_variant_round_robins_to_least_traded()]] - `calls` [EXTRACTED]
