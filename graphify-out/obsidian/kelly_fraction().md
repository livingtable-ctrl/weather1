...
## Connections
- [[dot-test_default_fee_rate_equals_kalshi_fee_rate()]] - `calls` [EXTRACTED]
- [[dot-test_default_smaller_than_zero_fee()]] - `calls` [EXTRACTED]
- [[dot-test_fee_adjusted_kelly_less_than_fee_free()]] - `calls` [EXTRACTED]
- [[dot-test_fee_adjusted_never_exceeds_fee_free_across_probs()]] - `calls` [EXTRACTED]
- [[dot-test_fee_reduces_kelly()]] - `calls` [EXTRACTED]
- [[dot-test_fee_wipes_small_edge()]] - `calls` [EXTRACTED]
- [[dot-test_half_kelly()]] - `calls` [EXTRACTED]
- [[dot-test_kelly_default_equals_kalshi_fee_rate()]] - `calls` [EXTRACTED]
- [[dot-test_kelly_fraction_caps_at_kelly_cap()]] - `calls` [EXTRACTED]
- [[dot-test_negative_edge_returns_zero()]] - `calls` [EXTRACTED]
