...
- [[test_no_new_unexplained_registry_gaps()]] - `calls` [EXTRACTED]
- [[test_report_covers_all_city_coords_cities()]] - `calls` [EXTRACTED]
- [[test_series_ticker_fully_covered()]] - `calls` [EXTRACTED]
- [[test_st_petersburg_series_ticker_comes_from_rain_not_high()]] - `calls` [EXTRACTED]
- [[test_station_bias_fully_covered()]] - `calls` [EXTRACTED]
