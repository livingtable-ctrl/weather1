...
# test_hurricane_next_event_ticker_shadow_only_when_gate_inactive()

## Connections
- [[A time-to-next-event (KXNEXTHURDATE) opp must be shadow-logged, not placed,…]] - `rationale_for` [EXTRACTED]
