...
- [[EdgeHistogram()]] - `contains` [EXTRACTED]
- [[EmosStatusCard()]] - `contains` [EXTRACTED]
- [[EquityCurveChart()]] - `contains` [EXTRACTED]
- [[ForecastHeatmapChart()]] - `contains` [EXTRACTED]
- [[MarketTypeSplitCard()]] - `contains` [EXTRACTED]
- [[MinEdgeBacktestChart()]] - `contains` [EXTRACTED]
- [[MultiDayCalibCard()]] - `contains` [EXTRACTED]
- [[ReliabilityDiagramChart()]] - `contains` [EXTRACTED]
