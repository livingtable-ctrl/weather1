...
## Connections
- [[dot-test_date_sold_differs_from_date_acquired()]] - `calls` [EXTRACTED]
- [[dot-test_date_sold_uses_settled_at()]] - `calls` [EXTRACTED]
- [[dot-test_december_trade_absent_from_entry_year()]] - `calls` [EXTRACTED]
- [[dot-test_december_trade_appears_in_settlement_year()]] - `calls` [EXTRACTED]
- [[dot-test_history_is_sorted_by_ts()]] - `calls` [EXTRACTED]
