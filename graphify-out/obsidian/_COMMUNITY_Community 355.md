...
## Members
- [[Every _ALLOWLIST entry must name a real file, a positive expected count, and a…_1]] - rationale - tests/test_paths_bypass_guard.py
- [[No .py file anywhere in the repo should construct its own data path locally.…]] - rationale - tests/test_paths_bypass_guard.py
- [[Path_25]] - code
- [[_all_source_files()_1]] - code - tests/test_paths_bypass_guard.py
...
- [[test_allowlist_entries_still_exist_and_are_justified()_1]] - code - tests/test_paths_bypass_guard.py
