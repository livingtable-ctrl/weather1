// Shared mock data for all dashboard variations
// Realistic shapes lifted from the Flask web_app.py / SSE stream

window.MOCK = (function () {
  // Generate a balance history walk
  ...
  // Calibration curve (forecast prob bucket -> realized win rate)
  const calibration = [
  ...
  // Brier history (last 30 days, lower better)
  const brierHist = (function () {
    let s = 11; function rng() { s = (s * 9301 + 49297) % 233280; return s / 233280; }
    const out = [];
    let v = 0.22;
    for (let i = 0; i < 60; i++) {
      v += (rng() - 0.55) * 0.01;
  ...
  // PnL attribution by signal source
  ...
  // Forecast detail for the strongest opportunity (Seattle)
  ...
  // ML calibration models trained per city
  const mlModels = [
  ...
  // Add missing fields for comprehensive prototype
  
  // Enhance opportunities with star ratings, Kelly $, flags
  opportunities.forEach((opp, i) => {
    ...
    opp.is_hedge = i === 5;
    opp.kelly_dollars = opp.edge * 1000 * 0.18; // simplified Kelly
  ...
  const closedTrades = [
    { ticker: 'KXHIGHCHI-24-MAY01', city: 'Chicago', side: 'yes', outcome: 'yes', pnl: 8.40, entered_at: '2024-04-30T14:22:00', entry_price: 0.42, current_yes_ask: null },
    { ticker: 'KXHIGHNYC-24-MAY02', city: 'NYC', side: 'no', outcome: 'no', pnl: 6.20, entered_at: '2024-04-29T09:15:00', entry_price: 0.38, current_yes_ask: null },
    { ticker: 'KXHIGHLA-24-MAY01', city: 'LA', side: 'yes', outcome: 'no', pnl: -12.50, entered_at: '2024-04-28T16:40:00', entry_price: 0.51, current_yes_ask: null },
    { ticker: 'KXHIGHPHX-24-APR30', city: 'Phoenix', side: 'yes', outcome: 'yes', pnl: 14.80, entered_at: '2024-04-27T11:05:00', entry_price: 0.36, current_yes_ask: null },
    { ticker: 'KXHIGHMIA-24-MAY03', city: 'Miami', side: 'no', outcome: 'yes', pnl: -9.20, entered_at: '2024-04-26T13:50:00', entry_price: 0.44, current_yes_ask: null },
    { ticker: 'KXHIGHHOU-24-MAY01', city: 'Houston', side: 'yes', outcome: 'yes', pnl: 11.30, entered_at: '2024-04-25T10:20:00', entry_price: 0.39, current_yes_ask: null },
    { ticker: 'KXHIGHCHI-24-APR28', city: 'Chicago', side: 'no', outcome: 'no', pnl: 7.60, entered_at: '2024-04-24T15:35:00', entry_price: 0.35, current_yes_ask: null },
    { ticker: 'KXHIGHNYC-24-APR29', city: 'NYC', side: 'yes', outcome: 'yes', pnl: 9.10, entered_at: '2024-04-23T08:45:00', entry_price: 0.41, current_yes_ask: null },
  ];

  // Risk metrics
  const agedPositions = [
    { ticker: 'KXHIGHCHI-26MAY07-T72', age_h: 42 },
    { ticker: 'KXHIGHDEN-26MAY10-T64', age_h: 38 }
  ];

  const correlatedEvents = [
    { date: '2026-05-12', cities: ['Chicago', 'NYC'], count: 2 },
    { date: '2026-05-14', cities: ['LA', 'Phoenix'], count: 2 }
  ];
  ...
  const cities = positions.map(p => p.city).filter((c, i, a) => a.indexOf(c) === i);
